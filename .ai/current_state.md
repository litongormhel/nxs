...
| Bookings | scheduling, therapist/room assignment, double-booking rules | `docs/state/bookings_state.md` |
...
| Dashboard | (removed) former reception home, stat cards | `docs/state/dashboard_state.md` |
