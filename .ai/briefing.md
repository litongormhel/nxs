...
1. **2026-09-21 — Add Resilient Fallback for quick_walkin RPC Parameter Signature**
...
2. **2026-09-21 — Add sms_confirmation_template Column to app_settings and Fix Variable Typo**
...
3. **2026-09-21 — Fix Empty Bookings Table After Adding Notes Column**
...
4. **2026-09-21 — Add Session Notes / Vehicle Info to Bookings and Display in Table**
...
5. **2026-09-21 — Fix Locker Out-of-Order Update Failure for Higher Locker Numbers**
