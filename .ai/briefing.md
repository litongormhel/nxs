...
1. **2026-09-17 — Fix EditBookingModal Self-Locker False Conflict & Therapist Availability Dropdown**
...
2. **2026-09-17 — Fix Archiving Therapist "Needs Reassignment" on Historical Bookings**
...
3. **2026-09-17 — Fix Check-in Time & Locker missing data + Add leftmost Edit Booking action & modal**
...
4. **2026-09-17 — Auto-cancel lapsed unvisited bookings past 2:00 AM cutoff**
...
5. **2026-09-16 — Log Visit: Link walk-in to client account (manual search + QR scan) & hide misleading points for unlinked guests**
