...
1. **2026-09-17 — Restrict Payment Method dropdown options & remove Logged by Staff in Quick Walk-In**
...
2. **2026-09-17 — Scale down Call Sheet typography and row density to match Bookings table styling**
...
3. **2026-09-17 — Align Quick Walk-in Split Payment UI to dropdown option "Split (Cash + GCash)"**
...
4. **2026-09-17 — Remove ACTION column and Check Out buttons from Bookings page**
   (`ohm#rembookingact`).
...
5. **2026-09-17 — Add Quick Search Bar and Time Slot Filters to Bookings Page**
