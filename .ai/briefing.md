...
1. **2026-09-17 — Link all Room dropdowns to configured Room Capacity (18) instead of hardcoded 20**
...
2. **2026-09-17 — Hide Massage Time / Schedule Picker when Service Downgraded to Wet Area in Edit Booking Modal**
...
3. **2026-09-17 — Dynamic Room/Therapist Handling & Sales Adjustment in Edit Booking Modal**
...
4. **2026-09-17 — Add Pre-Confirmation Summary Dialog in Log Visit Modal**
...
5. **2026-09-17 — Drop `one_active_occupant_per_room` Constraint from `locker_occupancy` to Decouple Room Sessions from Locker Stays**
